...
const spamton = {
  ...
  lines: [
    { text: "HURRY UP AND BUY!", sound: "/audio/spamton_line1.mp3" },
    { text: "DEALS SO GOOD I'LL [$!$$] MYSELF!", sound: "/audio/spamton_line2.mp3" },
    { text: "DELICIOUS KROMER", sound: "/audio/spamton_line3.mp3" },
    { text: "I’M [[HALF OFF]] TODAY!", sound: "/audio/spamton_line4.mp3" },
    { text: "WHAT ARE YOU WAITING FOR?", sound: "/audio/spamton_line5.mp3" },
    { text: "WHAT!? YOU WERE SO CLOSE!!", sound: "/audio/spamton_line6.mp3" }
  ],
  talk() {
